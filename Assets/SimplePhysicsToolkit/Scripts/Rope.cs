...
namespace SimplePhysicsToolkit {
	public class Rope : MonoBehaviour {
		...
		[Tooltip("Each point in the rope must have some mass for physics calculations, this allows you to alter the weight accordingly.")]
		public float ropeSegmentMass = 1f;
